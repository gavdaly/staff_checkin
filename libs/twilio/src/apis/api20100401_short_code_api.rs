...
pub async fn fetch_short_code(
...
) -> Result<crate::models::ApiPeriodV2010PeriodAccountPeriodShortCode, Error<FetchShortCodeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchShortCodeError> =
...
pub async fn list_short_code(
...
) -> Result<crate::models::ListShortCodeResponse, Error<ListShortCodeError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = short_code {
        local_var_req_builder =
            local_var_req_builder.query(&[("ShortCode", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListShortCodeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::ApiPeriodV2010PeriodAccountPeriodShortCode, Error<UpdateShortCodeError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateShortCodeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
