...
pub async fn fetch_authorized_connect_app(
    ...
    crate::models::ApiPeriodV2010PeriodAccountPeriodAuthorizedConnectApp,
    Error<FetchAuthorizedConnectAppError>,
> {
    ...
    let local_var_uri_str = format!(
        ...
        ConnectAppSid = crate::apis::urlencode(connect_app_sid)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchAuthorizedConnectAppError> =
...
pub async fn list_authorized_connect_app(
...
) -> Result<crate::models::ListAuthorizedConnectAppResponse, Error<ListAuthorizedConnectAppError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAuthorizedConnectAppError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
