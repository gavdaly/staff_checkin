...
pub async fn create_user_defined_message(
    ...
    crate::models::ApiPeriodV2010PeriodAccountPeriodCallPeriodUserDefinedMessage,
    Error<CreateUserDefinedMessageError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUserDefinedMessageError> =
