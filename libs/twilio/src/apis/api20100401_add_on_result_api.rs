...
pub async fn delete_recording_add_on_result(
    ...
    let local_var_uri_str = format!(
        ...
        ReferenceSid = crate::apis::urlencode(reference_sid),
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteRecordingAddOnResultError> =
...
pub async fn fetch_recording_add_on_result(
    ...
    crate::models::ApiPeriodV2010PeriodAccountPeriodRecordingPeriodRecordingAddOnResult,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchRecordingAddOnResultError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_recording_add_on_result(
...
) -> Result<crate::models::ListRecordingAddOnResultResponse, Error<ListRecordingAddOnResultError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListRecordingAddOnResultError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
