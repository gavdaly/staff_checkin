...
pub async fn create_message_feedback(
    ...
    crate::models::ApiPeriodV2010PeriodAccountPeriodMessagePeriodMessageFeedback,
    Error<CreateMessageFeedbackError>,
> {
    ...
    let local_var_uri_str = format!(
        ...
        MessageSid = crate::apis::urlencode(message_sid)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateMessageFeedbackError> =
...
pub async fn fetch_call_feedback(
    configuration: &configuration::Configuration,
    params: FetchCallFeedbackParams,
) -> Result<
    crate::models::ApiPeriodV2010PeriodAccountPeriodCallPeriodCallFeedback,
    Error<FetchCallFeedbackError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchCallFeedbackError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_call_feedback(
    configuration: &configuration::Configuration,
    params: UpdateCallFeedbackParams,
) -> Result<
    crate::models::ApiPeriodV2010PeriodAccountPeriodCallPeriodCallFeedback,
    Error<UpdateCallFeedbackError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateCallFeedbackError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
