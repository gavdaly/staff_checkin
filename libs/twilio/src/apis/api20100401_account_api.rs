...
) -> Result<crate::models::ApiPeriodV2010PeriodAccount, Error<CreateAccountError>> {
...
pub async fn fetch_account(
...
) -> Result<crate::models::ApiPeriodV2010PeriodAccount, Error<FetchAccountError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchAccountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::ListAccountResponse, Error<ListAccountError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ApiPeriodV2010PeriodAccount, Error<UpdateAccountError>> {
    let local_var_configuration = configuration;
