...
pub async fn delete_outgoing_caller_id(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteOutgoingCallerIdError> =
...
pub async fn fetch_outgoing_caller_id(
    ...
    Error<FetchOutgoingCallerIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchOutgoingCallerIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_outgoing_caller_id(
...
) -> Result<crate::models::ListOutgoingCallerIdResponse, Error<ListOutgoingCallerIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListOutgoingCallerIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_outgoing_caller_id(
    ...
    crate::models::ApiPeriodV2010PeriodAccountPeriodOutgoingCallerId,
    Error<UpdateOutgoingCallerIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateOutgoingCallerIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
