...
pub async fn list_dependent_phone_number(
...
) -> Result<crate::models::ListDependentPhoneNumberResponse, Error<ListDependentPhoneNumberError>> {
    ...
    let local_var_uri_str = format!(
        ...
        AddressSid = crate::apis::urlencode(address_sid)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListDependentPhoneNumberError> =
