...
pub async fn list_usage_record_this_month(
...
) -> Result<crate::models::ListUsageRecordThisMonthResponse, Error<ListUsageRecordThisMonthError>> {
    ...
    if let Some(ref local_var_str) = include_subaccounts {
        local_var_req_builder =
            local_var_req_builder.query(&[("IncludeSubaccounts", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListUsageRecordThisMonthError> =
