...
pub async fn delete_recording_transcription(
    ...
    let local_var_uri_str = format!(
        ...
        RecordingSid = crate::apis::urlencode(recording_sid),
...
) -> Result<crate::models::ListRecordingTranscriptionResponse, Error<ListRecordingTranscriptionError>>
{
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ListTranscriptionResponse, Error<ListTranscriptionError>> {
    let local_var_configuration = configuration;
