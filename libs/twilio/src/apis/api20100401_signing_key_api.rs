...
pub async fn delete_signing_key(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSigningKeyError> =
...
) -> Result<crate::models::ApiPeriodV2010PeriodAccountPeriodSigningKey, Error<FetchSigningKeyError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchSigningKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_signing_key(
...
) -> Result<crate::models::ListSigningKeyResponse, Error<ListSigningKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListSigningKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::ApiPeriodV2010PeriodAccountPeriodSigningKey, Error<UpdateSigningKeyError>>
{
    let local_var_configuration = configuration;
