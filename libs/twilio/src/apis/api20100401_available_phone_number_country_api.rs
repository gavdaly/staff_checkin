...
pub async fn fetch_available_phone_number_country(
    ...
    crate::models::ApiPeriodV2010PeriodAccountPeriodAvailablePhoneNumberCountry,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchAvailablePhoneNumberCountryError> =
...
pub async fn list_available_phone_number_country(
    ...
    crate::models::ListAvailablePhoneNumberCountryResponse,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAvailablePhoneNumberCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
