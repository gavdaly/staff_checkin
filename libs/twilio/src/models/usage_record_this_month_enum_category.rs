...
impl ToString for UsageRecordThisMonthEnumCategory {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::ConversationsConversationEvents => {
                String::from("conversations-conversation-events")
            }
            Self::ConversationsEndpointConnectivity => {
                String::from("conversations-endpoint-connectivity")
            }
            Self::ConversationsEvents => String::from("conversations-events"),
            Self::ConversationsParticipantEvents => {
                String::from("conversations-participant-events")
            }
            ...
            Self::GroupRoomsEncryptedMediaRecorded => {
                String::from("group-rooms-encrypted-media-recorded")
            }
            ...
            Self::MarketplaceAlgorithmiaNamedEntityRecognition => {
                String::from("marketplace-algorithmia-named-entity-recognition")
            }
            Self::MarketplaceCadenceTranscription => {
                String::from("marketplace-cadence-transcription")
            }
            ...
            Self::MarketplaceDeepgramPhraseDetector => {
                String::from("marketplace-deepgram-phrase-detector")
            }
            Self::MarketplaceDigitalSegmentBusinessInfo => {
                String::from("marketplace-digital-segment-business-info")
            }
            Self::MarketplaceFacebookOfflineConversions => {
                String::from("marketplace-facebook-offline-conversions")
            }
            Self::MarketplaceGoogleSpeechToText => {
                String::from("marketplace-google-speech-to-text")
            }
            Self::MarketplaceIbmWatsonMessageInsights => {
                String::from("marketplace-ibm-watson-message-insights")
            }
            Self::MarketplaceIbmWatsonMessageSentiment => {
                String::from("marketplace-ibm-watson-message-sentiment")
            }
            Self::MarketplaceIbmWatsonRecordingAnalysis => {
                String::from("marketplace-ibm-watson-recording-analysis")
            }
            Self::MarketplaceIbmWatsonToneAnalyzer => {
                String::from("marketplace-ibm-watson-tone-analyzer")
            }
            Self::MarketplaceIcehookSystemsScout => {
                String::from("marketplace-icehook-systems-scout")
            }
            Self::MarketplaceInfogroupDataaxleBizinfo => {
                String::from("marketplace-infogroup-dataaxle-bizinfo")
            }
            Self::MarketplaceKeenIoContactCenterAnalytics => {
                String::from("marketplace-keen-io-contact-center-analytics")
            }
            Self::MarketplaceMarchexCleancall => String::from("marketplace-marchex-cleancall"),
            Self::MarketplaceMarchexSentimentAnalysisForSms => {
                String::from("marketplace-marchex-sentiment-analysis-for-sms")
            }
            Self::MarketplaceMarketplaceNextcallerSocialId => {
                String::from("marketplace-marketplace-nextcaller-social-id")
            }
            Self::MarketplaceMobileCommonsOptOutClassifier => {
                String::from("marketplace-mobile-commons-opt-out-classifier")
            }
            Self::MarketplaceNexiwaveVoicemailToText => {
                String::from("marketplace-nexiwave-voicemail-to-text")
            }
            Self::MarketplaceNextcallerAdvancedCallerIdentification => {
                String::from("marketplace-nextcaller-advanced-caller-identification")
            }
            Self::MarketplaceNomoroboSpamScore => String::from("marketplace-nomorobo-spam-score"),
            Self::MarketplacePayfoneTcpaCompliance => {
                String::from("marketplace-payfone-tcpa-compliance")
            }
            Self::MarketplaceRemeetingAutomaticSpeechRecognition => {
                String::from("marketplace-remeeting-automatic-speech-recognition")
            }
            Self::MarketplaceTcpaDefenseSolutionsBlacklistFeed => {
                String::from("marketplace-tcpa-defense-solutions-blacklist-feed")
            }
            ...
            Self::MarketplaceTwilioCallerNameLookupUs => {
                String::from("marketplace-twilio-caller-name-lookup-us")
            }
            Self::MarketplaceTwilioCarrierInformationLookup => {
                String::from("marketplace-twilio-carrier-information-lookup")
            }
            Self::MarketplaceVoicebasePci => String::from("marketplace-voicebase-pci"),
            Self::MarketplaceVoicebaseTranscription => {
                String::from("marketplace-voicebase-transcription")
            }
            Self::MarketplaceVoicebaseTranscriptionCustomVocabulary => {
                String::from("marketplace-voicebase-transcription-custom-vocabulary")
            }
            Self::MarketplaceWhitepagesProCallerIdentification => {
                String::from("marketplace-whitepages-pro-caller-identification")
            }
            Self::MarketplaceWhitepagesProPhoneIntelligence => {
                String::from("marketplace-whitepages-pro-phone-intelligence")
            }
            Self::MarketplaceWhitepagesProPhoneReputation => {
                String::from("marketplace-whitepages-pro-phone-reputation")
            }
            Self::MarketplaceWolfarmSpokenResults => {
                String::from("marketplace-wolfarm-spoken-results")
            }
            ...
            Self::MarketplaceYticaContactCenterReportingAnalytics => {
                String::from("marketplace-ytica-contact-center-reporting-analytics")
            }
            ...
            Self::PeerToPeerRoomsParticipantMinutes => {
                String::from("peer-to-peer-rooms-participant-minutes")
            }
            ...
            Self::SmallGroupRoomsParticipantMinutes => {
                String::from("small-group-rooms-participant-minutes")
            }
            ...
            Self::SyncEndpointHoursAboveDailyCap => {
                String::from("sync-endpoint-hours-above-daily-cap")
            }
            ...
            Self::VerifyWhatsappConversationsBusinessInitiated => {
                String::from("verify-whatsapp-conversations-business-initiated")
            }
            ...
            Self::VoiceInsightsClientInsightsOnDemandMinute => {
                String::from("voice-insights-client-insights-on-demand-minute")
            }
            Self::VoiceInsightsPtsnInsightsOnDemandMinute => {
                String::from("voice-insights-ptsn-insights-on-demand-minute")
            }
            Self::VoiceInsightsSipInterfaceInsightsOnDemandMinute => {
                String::from("voice-insights-sip-interface-insights-on-demand-minute")
            }
            Self::VoiceInsightsSipTrunkingInsightsOnDemandMinute => {
                String::from("voice-insights-sip-trunking-insights-on-demand-minute")
            }
            Self::VoiceIntelligence => String::from("voice-intelligence"),
            Self::VoiceIntelligenceTranscription => {
                String::from("voice-intelligence-transcription")
            }
            ...
            Self::WirelessUsageCommandsCentralandsouthamerica => {
                String::from("wireless-usage-commands-centralandsouthamerica")
            }
            ...
            Self::WirelessUsageCommandsNorthamerica => {
                String::from("wireless-usage-commands-northamerica")
            }
            ...
            Self::WirelessUsageDataCentralandsouthamerica => {
                String::from("wireless-usage-data-centralandsouthamerica")
            }
            Self::WirelessUsageDataCustomAdditionalmb => {
                String::from("wireless-usage-data-custom-additionalmb")
            }
            Self::WirelessUsageDataCustomFirst5mb => {
                String::from("wireless-usage-data-custom-first5mb")
            }
            ...
            Self::WirelessUsageDataIndividualAdditionalgb => {
                String::from("wireless-usage-data-individual-additionalgb")
            }
            Self::WirelessUsageDataIndividualFirstgb => {
                String::from("wireless-usage-data-individual-firstgb")
            }
            Self::WirelessUsageDataInternationalRoamingCanada => {
                String::from("wireless-usage-data-international-roaming-canada")
            }
            Self::WirelessUsageDataInternationalRoamingIndia => {
                String::from("wireless-usage-data-international-roaming-india")
            }
            Self::WirelessUsageDataInternationalRoamingMexico => {
                String::from("wireless-usage-data-international-roaming-mexico")
            }
            ...
            Self::WirelessUsageDataPooledDownlink => {
                String::from("wireless-usage-data-pooled-downlink")
            }
            Self::WirelessUsageDataPooledUplink => {
                String::from("wireless-usage-data-pooled-uplink")
            }
