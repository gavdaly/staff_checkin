...
pub struct ListRecordingAddOnResultResponse {
    ...
    pub add_on_results: Option<
        Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodRecordingPeriodRecordingAddOnResult>,
    >,
...
impl Default for ListRecordingAddOnResultResponse {
    fn default() -> Self {
        Self::new()
    }
}
