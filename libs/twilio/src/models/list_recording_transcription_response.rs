...
pub struct ListRecordingTranscriptionResponse {
    ...
    pub transcriptions: Option<
        Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodRecordingPeriodRecordingTranscription>,
    >,
...
impl Default for ListRecordingTranscriptionResponse {
    fn default() -> Self {
        Self::new()
    }
}
