...
pub fn Vacations() -> impl IntoView {
    view! {
        <nav class="subWrapper">
            <A href="" exact=true>"Vacation List"</A>
            <A href="pending" exact=true>"Pending Vacations"</A>
            <A href="create" exact=true>"Request Vacation"</A>
        </nav>
        <section class="stack">
            <Outlet />
        </section>
