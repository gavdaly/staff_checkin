...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <Router fallback=|| {
            ...
            <button
                  class="button"
                  aria-label={format!("{label} main menu")}
                >
            ...
            // content for this welcome page
                ...
                <Show when=|| {is_authenticated()} fallback= || {view!{  }} >
                    <nav aria-label="Main menu" id="nav">
                        <A href="" class="link" exact=true>"dashboard"</A>
                        <A href="/check_in" class="link">"check in"</A>
                        <A href="/timesheet" class="link">"timesheet"</A>
                        <A href="/timesheets" class="link">"timesheets"</A>
                        <A href="/vacations" class="link">"vacations"</A>
